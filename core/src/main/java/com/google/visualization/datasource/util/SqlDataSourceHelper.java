...
public class SqlDataSourceHelper {
   ...
   * result as a DataTable.  This form allows integration with normal web-server
  ...
  public static DataTable executeQuery(Query query, SqlDatabaseDescription databaseDescription)
    ...
    return executeQuery(query, getDatabaseConnection(databaseDescription), databaseDescription.getTableName());
  }

  private static DataTable executeQuery(Query query, Connection con, String tableName) throws DataSourceException {
